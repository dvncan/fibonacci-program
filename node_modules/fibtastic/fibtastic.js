...
/**
 * Fibtastic provides methods for working with the Fibonacci sequence.
 * 
 * The `sequence` method is used for generating an array of values from the Fibonacci sequence
 * from a start to an end index.
 * 
 * The `value` method retrieves the Fibonacci value at the specified location in the Fibonacci
 * sequence.
 * 
 * The `isValue` method will check wehther a provided value is part of the Fibonacci sequence and
 * if it is, it will return the index in the sequence the value is located.
 */
 ...
 */
export function value(location) {
...
export function isValue(value) {
  ...
  else if (_isFib(value)) return _inverseBinets(value);
